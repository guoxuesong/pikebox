...
openclcmd('set_buffer', 0, buffA, int32([1,2,3;4,5,6;7,8,9]));
openclcmd('set_buffer', 0, buffB, int32([1,2,3;4,5,6;7,8,9]));

dims=size([1,2,3;4,5,6;7,8,9]);

rA = openclcmd('get_buffer', 0, buffA, 9, 'int32')
rB = openclcmd('get_buffer', 0, buffB, 9, 'int32')

reshape(rA,dims)
reshape(rB,dims)

kid = openclcmd('create_kernel', uint32([3,3,0]), uint32(dims), 'testint');
...
rC = openclcmd('get_buffer', 0, buffC, 9, 'int32')
reshape(rC,dims)
